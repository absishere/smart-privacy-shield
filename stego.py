...
from encrypt import ENCRYPTED_DIR, IMAGES_ROOT, ensure_directories
...
STEGO_DIR = IMAGES_ROOT / "hidden"
REVEAL_DIR = IMAGES_ROOT / "reveal"
...
def hide_image(
    ...
    *,
    ...
    cover_dir: Path = COVERS_DIR,
    secret_dir: Path = ENCRYPTED_DIR,
    output_dir: Path = STEGO_DIR,
    key: str | None = None,
) -> Path:
